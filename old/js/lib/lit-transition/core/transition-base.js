import { NodePart, html } from '../../lit-html/lit-html.js';
import { marked, pageVisible } from './utils.js';
const setup = new WeakMap();
// generates a directive
export function transitionBase(flow) {
    // generated directive
    return function _transition(tr, transition) {
        return async (container) => {
            ...
            const { enter, leave, onEnter, onLeave, onAfterEnter, onAfterLeave, mode = 'in-out' } = transition;
